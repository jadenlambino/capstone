...
class ListingForm(FlaskForm):
    ...
    def check_positive(form, field):
        num = field.data
        if num < 0:
            raise ValidationError('Please set a price larger than 0.')
    ...
    price = FloatField('Price', validators=[DataRequired('Please set a valid price for your listing, no letters or symbols are permitted.'), check_positive])
