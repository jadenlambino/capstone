...
class ListingForm(FlaskForm):
    product_tag = SelectField('Product Tag', choices=[(1,'Jacket'), (2, 'Shirt'), (3 , 'T-Shirt'), (4 , 'Sweatshirt'), (5 , 'Hoodie'), (6 , 'Jeans'), (7 , 'Pants'), (8 , 'Shorts'), (9 , 'Shoes'), (10 , 'Hats'), (11, 'Accessories')], validators=[DataRequired('Please select a category.')])
